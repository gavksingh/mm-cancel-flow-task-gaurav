...
export function ConfirmStep() {
    ...
    return (
        <>
            ...
            <div className="px-8 py-8 md:px-6 lg:px-10">
                <div className="text-center mb-8 max-w-[500px] md:max-w-[450px] lg:max-w-[500px] mx-auto">
                    ...
                    <p className="text-[15px] md:text-[14px] lg:text-[15px] text-gray-600 max-w-md mx-auto">
                        You'll lose access to all premium features immediately and this action cannot be undone.
                    </p>
                </div>

                <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-8 max-w-[500px] md:max-w-[450px] lg:max-w-[500px] mx-auto">
                    <p className="text-[14px] md:text-[13px] lg:text-[14px] text-red-800">
                        <strong className="font-semibold">Warning:</strong> You'll need to resubscribe at the full price if you change your mind later.
                    </p>
                </div>

                <div className="flex gap-3 max-w-[500px] md:max-w-[450px] lg:max-w-[500px] mx-auto">
