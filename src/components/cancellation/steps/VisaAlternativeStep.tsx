...
export function VisaAlternativeStep() {
    ...
    const handleCompleteCancellation = async () => {
        ...
        try {
            ...
            alert('There was an error processing your cancellation. Please try again.')  // Add this
        } finally {
            ...
            <div className="hidden md:block">
                ...
                <div className="flex p-6 md:p-6">
                    ...
                    <div className="flex-1 pr-6 max-w-[600px]">
                        <h2 className="text-[34px] leading-tight font-bold text-gray-600 mb-0">
                            You landed the job!
                        </h2>
                        <h3 className="text-[34px] leading-tight font-bold text-gray-600 italic mb-6">
                            That's what we live for.
                        </h3>
